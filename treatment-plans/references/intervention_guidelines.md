...
- Ivabradine (if EF ≤35%, HR >70 on max beta-blocker)
...
- Pharmacotherapy (GLP-1 agonists, orlistat) or bariatric surgery for BMI ≥30-35 with comorbidities
...
**Evidence**: 50-60% achieve ≥50% pain relief, improves function
