...
**Format Requirements:**
- Use colored box (Markdown blockquote or table) to make it visually prominent
...
- Goals meet SMART criteria (≥90%)
- Interventions have clear rationales (≥95%)
- Monitoring plan includes frequency (≥95%)
- Patient education documented (100%)

### Clinical Quality Metrics
- Evidence-based interventions (≥90%)
- Guideline-concordant care (≥85%)
- Avoidance of low-value care (100%)
- Appropriate preventive care included (≥95%)

### Patient-Centered Metrics
- Patient preferences documented (≥90%)
- Shared decision-making noted (≥85%)
- Culturally appropriate care (100%)
- Health literacy addressed (≥90%)
